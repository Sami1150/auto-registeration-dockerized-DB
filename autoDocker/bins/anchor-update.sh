...
configtxgen -outputAnchorPeersUpdate ./config/peer-update.tx   -asOrg $ORG_NAME -channelID automobilechannel  -profile AutomobileChannel

FABRIC_CFG_PATH=$PEER_FABRIC_CFG_PATH

peer channel update -f ./config/peer-update.tx -c automobilechannel -o $ORDERER_ADDRESS $TLS_PARAMETERS
